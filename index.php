...
//              It was, he didn't want ti so I stole it for myself
//              to host addinall.org and leave my other page
//              hosting addinall.com.au
...
<title>Mark Addinall - addinall.org</title>
<meta charset="utf-8">
...
<body id="page">
    ...
    <div id="content">
        <div class="g1">
            <h3><?php echo '<a href="http://www.addinall.com.au/contact.php" target="_blank">' . $sidebar_header . "</a>"; ?></h3>
            <p>
...
-->
            ...
            <p>
                <audio preload="none" controls>
                    <source src="AudioPlayer/audio/zhu.mp3"> 
                    <source src="AudioPlayer/audio/zhu.ogg"> 
                    <source src="AudioPlayer/audio/zhu.wav"> 
                </audio>
            </p>
            <h5>Thirsty Eye</h5>
            <p>
                <audio preload="none" controls>
                    <source src="AudioPlayer/audio/thirsty.mp3"> 
                    <source src="AudioPlayer/audio/thirsty.ogg"> 
                    <source src="AudioPlayer/audio/thirsty.wav"> 
                </audio>
            </p>
            <h5>Pickles from the Jar</h5>
            <p>
                <audio preload="none" controls>
                    <source src="AudioPlayer/audio/pickles.mp3"> 
                    <source src="AudioPlayer/audio/pickles.ogg"> 
                    <source src="AudioPlayer/audio/pickles.wav"> 
                </audio>
            </p>
            <h5>All Night</h5>
            <p>
	            <audio preload="none" controls>
		            <source src="AudioPlayer/audio/night.mp3">
		            <source src="AudioPlayer/audio/night.ogg">
		            <source src="AudioPlayer/audio/night.wav">
	            </audio>
            </p>
            <h5>Cross Eyed Woman</h5>
            <p>
	            <audio preload="none" controls>
		            <source src="AudioPlayer/audio/cross.mp3">
		            <source src="AudioPlayer/audio/cross.ogg">
		            <source src="AudioPlayer/audio/cross.wav">
	            </audio>
            </p>
            <h5>Death Grips</h5>
            <p>
	            <audio preload="none" controls>
		            <source src="AudioPlayer/audio/death.mp3">
		            <source src="AudioPlayer/audio/death.ogg">
		            <source src="AudioPlayer/audio/death.wav">
	            </audio>
            </p>
        </div>

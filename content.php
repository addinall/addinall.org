...
<p>This is one page of two at the moment.  You may have seen my other page just now!  If not, it is a more traditional shape and contains a lot more links to my work.  <a href="http://www.addinall.com.au">addinall.com.au</a>. Here is a very recent example of another one page/landing page/micro-site at <a href="http://www.theconsternation.com" target="_blank">The Consternation</a></p>
<p>
I completed degrees (post grad) in engineering and IT in the past. The last attendence in person being 1992.  So possibly no longer relevant.  Details in my <a href="../Mark_Addinall_Software.pdf" target="_blank">LONG CV!</a>  Recently I have been making use of Web based distance education a great deal.  A link to some of my recent results can be found <a href="http://www.addinall.com.au/Recent_results/compile.pdf" target="_blank">HERE</a>.  I am committed so far to another two years consisting of Biology, Epidemiology and Education studies.  I have an idea that my IT future will probably be either in the Life Sciences or Education fields.  I am still interested in mainstream coding.  Looking at Bioinformatic and Educational software tells me that they need help; right now! The ability to be creative in a position very welcome. Open for offers! 
</p>
